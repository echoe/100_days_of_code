...
# print(sample_data['Time Series (Daily)']['2025-09-29']['4. close'])
# for item in sample_data['Time Series (Daily)']:
#     print(sample_data['Time Series (Daily)'][item])

# result=[value for (key, value) in sample_data['Time Series (Daily)'].items()]
# print(result)